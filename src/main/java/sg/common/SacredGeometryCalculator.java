  ...
  static String calculateHelper(
    ...
    for (PostfixExpression exp1 : odds.elementSet()) {
      ...
      for (PostfixExpression exp2 : evens.elementSet()) {
        ...
        // O - E => O
        for (char operator : Operators.ADD_SUB) {
          result =
              calculateHelper(
                  valueSets,
        ...
        result =
            calculateHelper(
                valueSets,
                newSet(PostfixExpression.create(exp2, exp1, Operators.SUB), odds, exp1),
                newSet(evens, exp2),
                targetSet);
        if (!Strings.isNullOrEmpty(result)) {
          return result;
    ...
    for (PostfixExpression exp1 : odds.elementSet()) {
      ...
      for (PostfixExpression exp2 : odds.elementSet()) {
        ...
        result =
            calculateHelper(
                valueSets,
                newSet(PostfixExpression.create(exp1, exp2, Operators.DIV), odds, exp1, exp2),
                evens,
                targetSet);
        if (!Strings.isNullOrEmpty(result)) {
          return result;
        ...
        if (exp1.expressionResult() % 4 == 0) {
          result =
              calculateHelper(
                  valueSets,
                  odds,
                  newSet(PostfixExpression.create(exp1, exp2, Operators.DIV), evens, exp1, exp2),
                  targetSet);
        } else {
          result =
              calculateHelper(
                  valueSets,
                  newSet(PostfixExpression.create(exp1, exp2, Operators.DIV), odds),
      ...
      for (PostfixExpression exp2 : evens.elementSet()) {
        ...
        result =
            calculateHelper(
                valueSets,
                newSet(odds, exp1),
                newSet(PostfixExpression.create(exp1, exp2, Operators.MULT), evens, exp2),
                targetSet);
        if (!Strings.isNullOrEmpty(result)) {
          return result;
        }
        ...
        result =
            calculateHelper(
                valueSets,
                newSet(odds, exp1),
                newSet(PostfixExpression.create(exp2, exp1, Operators.DIV), evens, exp2),
                targetSet);
        if (!Strings.isNullOrEmpty(result)) {
          return result;
        }
    ...
    for (PostfixExpression exp1 : odds.elementSet()) {
      ...
      for (PostfixExpression exp2 : odds.elementSet()) {
        ...
        // O - O => E
        // O * O => O
        for (char operator : Operators.ADD_SUB_MULT) {
          result =
              calculateHelper(
                  valueSets,
